function Planetary(){
 ...
 this.initCircling = function(planetID){
  ...
  this.drawArm1 = function(centerPositionX,centerPositionY,gear_status){
    this.Arm_center = -150
    this.Axis_len = 350
    this.startX = this.Arm_center+this.Axis_len
    this.startY = 0
    ...
    this.dist_e = dist(this.pl_dot_x1,this.pl_dot_y1,this.Axis_X-centerPositionX,this.Axis_Y-centerPositionY)
    this.dist_x = abs(this.pl_dot_x1 - (this.Axis_X-centerPositionX))
    this.dist_y = abs(this.pl_dot_y1 - (this.Axis_Y-centerPositionY))

    pop()

    this.step1_y = sq(this.dist_e) + sq(this.dist_x) - sq(this.dist_y)
    this.step2_y = 2*this.dist_e*this.dist_x
    this.angle_cosine_y = this.step1_y/this.step2_y
    this.step3_y =acos(this.angle_cosine_y)
    this.angle_y =degrees(this.step3_y)

    this.step1_e = sq(this.dist_a) + sq(this.dist_d) - sq(this.dist_e)
    this.step2_e = 2*this.dist_a*this.dist_d
...
/* Start Calcurating a wing */
    ...
    var rightTurn2 = 180-(this.angle_e+this.angle_c)
  ...
  this.drawArm2 = function(centerPositionX,centerPositionY,gear_status){
    ...
    stroke(color(tempC))
      ...
      this.dist_e2 = dist(this.pl_dot_x2,this.pl_dot_y2,this.Axis_X2-centerPositionX,this.Axis_Y2-centerPositionY)
      this.dist_x2 = abs(this.pl_dot_x2 - (this.Axis_X2-centerPositionX))
      this.dist_y2 = abs(this.pl_dot_y2 - (this.Axis_Y2-centerPositionY))

    pop()

    this.step1_y2 = sq(this.dist_e2) + sq(this.dist_x2) - sq(this.dist_y2)
    this.step2_y2 = 2*this.dist_e2*this.dist_x2
    ...
    this.step1_e2 = sq(this.dist_a) + sq(this.dist_d) - sq(this.dist_e2)
    this.step2_e2 = 2*this.dist_a*this.dist_d
    this.angle_cosine_e2 = this.step1_e2/this.step2_e2
    this.step3_e2 =acos(this.angle_cosine_e2)
    this.angle_e2 =degrees(this.step3_e2)
...
/* Start Calcurating a wing */
    ...
    var rightTurn2 = 180-(this.angle_e2+this.angle_c)
  ...
  this.initArm = function(){
    ...
    this.step1_d2 = sq(this.dist_a) + sq(this.dist_e) - sq(this.dist_d)
    this.step2_d2 = 2*this.dist_a*this.dist_e
